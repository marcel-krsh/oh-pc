	...
	<tr>
        ...
        <td class="hasdivider">
        	...
        	<div class="uk-display-inline-block uk-text-center fullwidth uk-margin-small-top " uk-grid>
            	...
            	<div :class="{'uk-width-1-3':true, 'use-hand-cursor':true, [audit.ltAuditStatusClass]:true}" :uk-tooltip="audit.tooltipLtAuditStatus"  v-on:click.native="openFindings(this, audit.auditId, null, null, 'lt')" >
