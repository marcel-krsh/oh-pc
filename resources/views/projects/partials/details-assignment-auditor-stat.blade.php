...
<div id="project-details-info-assignment-auditor-calendar" class="grid-schedule uk-padding-remove uk-width-1-1 uk-margin">
	...
	<div class="grid-schedule-footer">
		<div uk-grid>
			<div class="uk-width-1-3 uk-padding-remove"><i class="a-arrow-left-2"></i> {{$data['calendar']['footer']['previous']}}</div>
			<div class="uk-width-1-3 uk-text-center"><i class="a-calendar-pencil"></i> {{$data['calendar']['footer']['today']}}</div>
			<div class="uk-width-1-3 uk-text-right">{{$data['calendar']['footer']['next']}} <i class="a-arrow-right-2_1"></i></div>
		</div>
	</div>
</div>
<script>
