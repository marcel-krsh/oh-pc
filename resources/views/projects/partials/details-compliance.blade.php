	...
	<div class="uk-width-1-1">
		...
		<div class="project-details-info-compliance-summary uk-margin-top uk-margin-left uk-margin-right uk-grid-match" uk-grid>
			<div class="uk-width-1-5">
				...
				<a onclick="dynamicModalLoad('projects/{{$data["project"]["id"]}}/programs/0/summary',0,0,1);" class="uk-button uk-button-small uk-button-success " style="margin-top: 18px;"><i class="a-arrow-diagonal-both use-hand-cursor" ></i> SWAP UNITS</a>
			</div>
