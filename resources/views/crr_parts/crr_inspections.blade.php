...
<div uk-grid class="uk-margin-bottom">
	<div class="uk-width-1-1 crr-blocks" style="page-break-inside: avoid;">
		<h2>Units Inspected: </h2> @can('access_auditor') || <button class="uk-button uk-button-primary button-finding-filter" onclick="dynamicModalLoad('projects/{{$audit->project->id}}/programs/0/summary',0,0,2);"><i class="a-arrow-diagonal-both use-hand-cursor" uk-tooltip="pos:top-left;title:CLICK TO SWAP UNITS;"  title="" aria-expanded="false"></i> SWAP UNITS </button>@endCan
