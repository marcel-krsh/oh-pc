	...
	function resolveFinding(findingid, dateResolved){
		...
		$.post('/findings/'+findingid+'/resolve', {
			...
			if(data != 0){
				...
				$('#inspec-tools-finding-resolve-'+resolveFindingId).html('<button class="uk-button uk-link uk-margin-small-left uk-width-1-2" onclick="resolveFinding(\''+resolveFindingId+'\',\'null\')"><span class="a-circle-cross">&nbsp;</span>CLEAR</button>');
			}else{
