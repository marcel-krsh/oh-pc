...
<title>Allita Blight Manager 1.01c</title>
					...
					<div class="uk-grid " >
						...
						<div class="uk-visible@m uk-width-1-3@m">
							<div id="user-logged-in allita-nav-bar-margin">
								...
								<div id="logged-in-user-links"><a href="javascript:logout()" class="uk-dark uk-link-muted uk-light">LOGOUT</a> | <a class="uk-dark uk-link-muted uk-light" onclick="loadListTab('/lists/activity_log')" >VIEW ACTIVITY LOG</a></div>
