...
if ($allowPageLoad) {
  ?>
	...
	<link href="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css{{ asset_version() }}" rel="stylesheet" />
	@endif
			...
			<div id="main-window" class=" uk-margin-large-bottom" uk-scrollspy="cls:uk-animation-fade; delay: 900">
				...
				<div id="dynamic-modal-2" uk-modal>
					...
					<script>
						 $(function() {
						    // Handler for .ready() called.
						    $('#dynamic-modal-content-2').css({"min-height":"500px","max-height":"680px"});
						  });
					</script>
				</div>
				<div id="dynamic-modal-3" uk-modal>
					...
					<script>
						 $(function() {
						    // Handler for .ready() called.
						    $('#dynamic-modal-content-3').css({"min-height":"500px","max-height":"680px"});
						  });
					</script>
				</div>

				<div id="dynamic-modal-communications" uk-modal>
					<div  class="uk-modal-dialog uk-modal-body uk-modal-content" style="min-width: 1250px; min-height: 800px; max-height: 800px; overflow-y: scroll;">
...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/multiple-select/1.2.0/multiple-select.min.css{{ asset_version() }}" />
	<script src="https://cdnjs.cloudflare.com/ajax/libs/multiple-select/1.2.0/multiple-select.min.js{{ asset_version() }}"></script>
	<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js{{ asset_version() }}"></script>
	<script>
		$('select').multipleSelect();
	</script>
</head>
