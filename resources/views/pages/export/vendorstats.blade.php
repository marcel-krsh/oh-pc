...
<div class="uk-grid">
	...
	<div class="uk-width-1-1 uk-width-2-3@m uk-align-center uk-margin-top">
	    <div class="uk-panel uk-panel-box uk-text-center">
	    	...
	    	<br />
	    	<h1 class="uk-panel-title">Vendor Stats Export Reports</h1>
		</div>
	</div>
	@if($pending_reports)
	<div class="uk-width-1-1 uk-width-2-3@m uk-align-center">
		<div class="uk-alert uk-alert-primary uk-text-center">A report is being processed. Please come back in a couple of hours.</div>
	</div>
	@endif
		...
		@if(count($files)>0)
		 	<h4 class="uk-text-left">{{count($files)}} FILES 
		 		<small>
		            ...
		            <a href="/reports/export_vendor_stats_process" class="uk-button uk-button-default uk-button-small uk-align-right">
		                EXPORT VENDOR STATS NOW
		            </a>
		        </small>
		    </h4>
	    	<hr />
		 	...
		 	<table class="uk-table uk-table-hover uk-table-striped uk-table-condensed small-table-text">
		        ...
		        <tbody>
		        	...
		        	<tr>    
                        ...
                        <td>
                        	<a class="a-lower" href="/reports/export_vendor_stats/{{$file['id']}}/download" title="Download"></a>
                        </td>
                    </tr>
				 	@endforeach
		        </tbody>
