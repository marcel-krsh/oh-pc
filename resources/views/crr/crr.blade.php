...
@section('head')
<title>{{ $report->template()->template_name }}: {{ date('y',strtotime($report->created_at)) }}-{{ $report->project->project_number }} AUDIT: {{ $report->audit->id }}.{{ str_pad($report->version, 3, '0', STR_PAD_LEFT) }}</title>
