	<div id="building-r-{{$target}}-details" class="rowinset indent">
		<div class="building-details uk-overflow-auto" style="">
			<div class="sortable" uk-sortable="handle: .uk-sortable-details">
				...
				<div id="building-detail-r-{{$key}}" class="building uk-flex uk-flex-row building-detail @if($detail['status']) building-detail-{{$detail['status']}} {{$detail['status']}} @endif " >
					<div id="building-detail-{{$target}}-c-1-{{$key}}" class="uk-inline uk-sortable-details" style="    min-width: 16px; padding: 0 3px;">
						...
						<span id="building-detail-rid-1" class="uk-position-bottom-center colored"><small>#<span class="rowindex">{{$loop->iteration}}</span></small></span>
					</div>
					...
					<div id="building-detail-{{$target}}-c-4-{{$key}}">
						<div uk-grid>
					...
					<div id="building-detail-{{$target}}-c-5-{{$key}}">
