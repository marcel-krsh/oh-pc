<div id="dynamic-modal-content">
	...
	<div class="uk-container uk-container-center"> <!-- start form container -->
		<div class="uk-grid">
			...
			@if (count($errors) > 0)
		    <div class="uk-width-1-1 uk-panel uk-margin-top uk-margin-bottom">
		        <ul>
			...
			@endif
			<form id='userform' action="/modals/user/edit/{{ $editUser->id }}" method="post" role="form" class="uk-width-1-1">
				{{csrf_field()}}
