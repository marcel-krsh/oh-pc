<div id="dynamic-modal-content">
                        ...
                        <div class="uk-form-controls">
                            <div id="category-list"> 
				                    <ul class="uk-subnav document-category-menu" style="margin-left: 20px">
				                        ...
				                        <li>
				                            <input class="uk-checkbox" name="category-id-checkbox" id="category-id-{{ $category->id }}" value="{{ $category->id }}" type="checkbox" <?php if(in_array($category->id, $categories_used)){ echo "checked";} ?>>
	...
	function editdocument(id) {
		...
		$.post('/modals/edit-document/{{ $document->id }}', {
			...
			if(data!='1'){ 
				...
				//UIkit.modal.alert('The document has been saved.');
				loadParcelSubTab('documents',{{ $document->parcel_id }});
