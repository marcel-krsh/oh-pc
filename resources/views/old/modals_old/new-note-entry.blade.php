		...
		<form name="newNoteForm" id="newNoteForm" method="post">
			...
			<div class="uk-container uk-container-center">
				...
				<div class="uk-grid uk-grid-small">
					<div class="uk-width-8-10">Note for File: {{$parcel->id}}</div>
				</div>
				<div class="uk-grid ">
					<!--END second row-->		
					<div class="uk-width-1-1">
						<div class="uk-grid">
								...
								<div class="uk-width-1-1">
									<div class="field-box" style="min-height:3em;">
										<div class="uk-grid uk-grid-collapse">
											<div class="uk-width-1-10"><label>NOTE</label></div>
											<div class="uk-width-9-10"><textarea id="file-note" rows="8" name="file-note" placeholder="Enter note here."></textarea></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="uk-width-1-4 ">
								<a class="uk-button uk-width-1-1 uk-button-primary" onclick="submitNewNote({{$parcel->id}})"><span uk-icon="save"></span> SAVE</a>
							</div>
						</div>
					</div>
