...
@section('content')
	...
	<form action="{{ route('import.corrections') }}" method="post" id="submit-mapping">
		...
		<div class="uk-form-row">
			@if($skipMapping != 1)<button  type="submit" name="submit" class="uk-button uk-button-default uk-button-large uk-margin-top uk-align-center uk-width-1-2">GOOD TO GO!</button>@endif
		</div><!-- uk-form-row -->
	</form>
