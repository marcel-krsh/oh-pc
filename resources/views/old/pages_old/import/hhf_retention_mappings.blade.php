					...
					<div class="uk-block uk-block-primary uk-dark uk-light">
                        <div class="uk-container">
                        	<div class="uk-grid">
	                            ...
	                            <div class="uk-width-4-5@m"><h1 class="blue-shadow">VALIDATION (mappings.blade)</h1><hr style="border-top: 2px dotted;" /><br />
		                            <div class="uk-grid ">
		                            	<div class="uk-width-1-3@m  uk-row-first">
		                                    <div class="uk-panel">
		                                        <h3>Import Complete</h3><p>{{$rowCount}} rows processed.<br />{{$ignored}}<br />{{$inserted}} inserted<br /> {{$updated}} updated <br />{{$totalTime}}</p>
		                                    </div>
		                                </div>
				...
				<div class="uk-grid">
					...
					<script type="text/javascript">
						...
						function loadNextResult(list,rowNum){
							var listURI = '/validate_hhf_retention_parcel?list='+list+'&rowNum='+rowNum;
