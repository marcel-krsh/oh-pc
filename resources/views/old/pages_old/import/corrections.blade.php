...
@section('content')
	...
	<div uk-grid>
		<div class="uk-width-1-1 uk-grid-collapse" style="padding-left: 0;">
					...
					<div class="uk-block uk-block-primary uk-dark uk-light">
                        <div class="uk-container">
                        	<div uk-grid>
	                            ...
	                            <div class="uk-width-4-5@m" style="padding-right: 25px;"><h1 class="blue-shadow">IMPORT SUMMARY</h1><hr style="border-top: 2px dotted;" /><br />
