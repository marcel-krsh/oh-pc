        ...
        <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td><small>@if($user->has_address())<div class="uk-align-right">{!!$user->organization_details->address->formatted_address()!!}@else NA @endif</div><a target="_blank" href="https://www.google.com/maps?q={{$user->organization_details->address->formatted_address()}}" class="uk-text-muted uk-align-right"><i class="a-marker-basic uk-text-muted uk-link"></i></a> </small></td>
