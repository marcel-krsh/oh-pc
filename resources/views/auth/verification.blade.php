...
<div class="uk-vertical-align uk-text-center uk-margin-large-bottom  uk-margin-top" uk-scrollspy="target:#login-panel;cls:uk-animation-slide-top-small uk-transform-origin-bottom; delay: 1300">
  <div class="uk-vertical-align-middle login-panel"  id="login-panel">
    ...
    <p>Your verification code is on its way. Please be patient, as it may take up to 5 minutes for it to arrive.</p>
    <form class="uk-panel uk-panel-box uk-form" role="registrationForm" method="POST" action="{{ url('verification') }}" autocomplete="off">
      ...
      <div class="uk-form-row" uk-scrollspy="target:.uk-input;cls:uk-animation-slide-top-small; delay: 1500">
        <input class="uk-input uk-width-1-1 uk-form-large" placeholder="ENTER YOUR CODE: 000-000-000" id="verification_code" type="text" name="verification_code" required autofocus autocomplete="false" style="font-size:24px;" >
      ...
      <div class="uk-form-row" uk-scrollspy="target:.uk-button;cls:uk-animation-slide-top-small; delay: 1600">
        <button id="verify-button" type="submit" class="uk-width-1-1 uk-button uk-button-primary uk-button-large">Verify</button>
