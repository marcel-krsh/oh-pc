		...
		<div class="uk-grid">
			<div class="uk-width-1-1@m uk-width-1-1@s">
				...
				<form id='transactionForm' class="uk-form-horizontal" role="form">
					...
					<div class="uk-form-row">
                        <label class="uk-form-label" for="amount">From Account</label>
                        <div class="uk-form-controls">
					...
					<div class="uk-form-row">
                        <label class="uk-form-label" for="amount">To Account</label>
                        <div class="uk-form-controls">
                            <div class="uk-button uk-button-default uk-form-select" data-uk-form-select>
    							<span></span>
							    <select name="status_id" id="status_id" class="uk-select">
					...
					<div class="uk-form-row">
                        <label class="uk-form-label" for="amount">Transaction Type</label>
                        <div class="uk-form-controls">
                            <div class="uk-button uk-button-default uk-form-select" data-uk-form-select>
    							<span></span>
							    <select name="status_id" id="status_id" class="uk-select">
			...
			<div id="applicant-info-update">
				<div class="uk-grid uk-margin">
					<div class="uk-width-1-3 uk-push-1-3">
						<a class="uk-button uk-button-primary blue-button uk-width-1-1" onclick="dynamicModalClose();"> <span uk-icon="times-circle" class="uk-margin-left"></i> CANCEL</a>
					</div>
					<div class="uk-width-1-3 uk-push-1-3">
