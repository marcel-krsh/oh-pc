		        ...
		        <tr id="audit-r-1" class="notcritical">
		            ...
		            <td id="audit-c-2-1" class="audit-td-project">
		            	...
		            	<div class="uk-vertical-align-middle uk-display-inline-block">
		            		<h3 id="audit-project-name-1" class="uk-margin-bottom-remove uk-link" uk-tooltip="title:Open Audit Details in Tab;" onClick="loadTab('{{ route('project', '19200114') }}', '4', 1);">19200114</h3>
