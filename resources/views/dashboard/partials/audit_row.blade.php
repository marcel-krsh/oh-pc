...
<td id="audit-c-2-{{ $audit->audit_id }}" class="audit-td-project" align="center">
	...
	<div class="uk-vertical-align-middle uk-display-inline-block use-hand-cursor"  onClick="openProject({{$audit->project_key}},{{$audit->audit_id}}); <?php /* openProjectDetails({{ $audit->audit_id }},{{ $audit->total_buildings }}) */ ?>" >
