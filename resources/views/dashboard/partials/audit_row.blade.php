	...
	<div class="uk-text-center fullwidth  uk-remove-margin" uk-grid>
		...
		<div class="uk-width-1-3  uk-remove-margin uk-padding-remove audit-list-report-holder" style="overflow: hidden;">
			<div class="audit-list-report-icons">
				...
				@else
				<i  @if($auditor_access)@if($audit->step_id > 59 && $audit->step_id < 67) class="a-file-plus use-hand-cursor" uk-tooltip title="GENERATE THIS AUDIT'S 8823" onclick="submitNewReportAL({{$audit->audit_id}},5)" @else class="a-file-fail gray-text" uk-tooltip title="SORRRY, THE AUDIT'S STATUS DOES NOT ALLOW A 8823 TO BE GENERATED." @endIf @else uk-tooltip title="SORRRY, THE 8823 GENERATOR IS NOT AVAILABLE YET."@endif></i><br /><small class="gray-text">8823</small>
				@endIf
			</div>
		</div>
	</div>
