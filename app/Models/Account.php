...
class Account extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Program::class, 'owner_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\CostItem::class, 'account_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\RequestItem::class, 'account_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\PoItems::class, 'account_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Parcel::class, 'account_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\InvoiceItem::class, 'account_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Parcel::class)
    ...
    {
        return $this->hasMany(\App\Models\CostItem::class)
    ...
    {
        return $this->hasMany(\App\Models\PoItems::class)
