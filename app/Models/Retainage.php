...
class Retainage extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\CostItem::class, 'cost_item_id', 'id');
    }
    ...
    {
        return $this->belongsToMany(\App\Models\Document::class, 'document_to_retainage', 'retainage_id', 'document_id');
    }
}
