...
class ReimbursementPurchaseOrders extends Model
{
    ...
    {
        return $this->belongsToMany(\App\Models\Parcel::class, 'parcels_to_purchase_orders', 'purchase_order_id', 'parcel_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\PurchaseOrderNote::class, 'purchase_order_id', 'id')
                ->with('owner')
    ...
    public function poItems()
    {
        ...
        return $this->hasMany(\App\Models\PoItems::class, 'po_id', 'id')
          ->has('requestItem');
    }
