...
class User extends Authenticatable
{
	...
	public function communications_owner()
	{
		return $this->hasMany(Communication::class, 'owner_id', 'id');
	}

	public function communications_receipient()
	{
		return $this->hasManyThrough('App\Models\Communication', '\App\Models\CommunicationRecipient', 'user_id', 'id', 'id', 'communication_id');
	}
}
