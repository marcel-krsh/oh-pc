...
class RecaptureInvoice extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\RecaptureItem::class, 'recapture_invoice_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\RecaptureInvoiceNote::class, 'recapture_invoice_id', 'id')
                ->with('owner')
