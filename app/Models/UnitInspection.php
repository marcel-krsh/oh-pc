...
class UnitInspection extends Model
{
	...
	{
		return $this->hasMany(\App\Models\Document::class, 'unit_ids', 'unit_id');
	}
	...
	{
		return $documents = \App\Models\Document::with('audits')->whereJsonContains('unit_ids', "$this->unit_id")->get();
	}
