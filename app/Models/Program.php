    ...
    public function isInGroup($group) : bool
    {
	    ...
	    switch ($group) {
		    ...
		    case 2:
		    	// 2 - 811 units
	    		$program_811_ids = explode(',', SystemSetting::get('program_811'));
	    		if(in_array($this->id, $program_811_ids)) return true;
		        break;
		    case 3:
		    	// 3 - Medicaid units
	    		$program_medicaid_ids = explode(',', SystemSetting::get('program_medicaid'));
	    		if(in_array($this->id, $program_medicaid_ids)) return true;
		        break;
		    case 4:
		    	// 4 - HOME
	    		$program_home_ids = explode(',', SystemSetting::get('program_home'));
	    		if(in_array($this->id, $program_home_ids)) return true;
		        break;
		    case 5:
		    	// 5 - OHTF
	    		$program_ohtf_ids = explode(',', SystemSetting::get('program_ohtf'));
	    		if(in_array($this->id, $program_ohtf_ids)) return true;
		        break;
		    case 6:
		    	// 6 - NHTF
	    		$program_nhtf_ids = explode(',', SystemSetting::get('program_nhtf'));
	    		if(in_array($this->id, $program_nhtf_ids)) return true;
		        break;
		    case 7:
		    	// 7 - HTC
	    		$program_htc_ids = explode(',', SystemSetting::get('program_htc'));
	    		if(in_array($this->id, $program_htc_ids)) return true;
		        break;
		}
