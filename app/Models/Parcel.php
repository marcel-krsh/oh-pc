...
class Parcel extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\TargetArea::class, 'target_area_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Compliance::class, 'parcel_id', 'id')->orderBy('id', 'DESC');
    }
    ...
    {
        return $this->hasMany(\App\Models\RecaptureItem::class, 'parcel_id', 'id')->orderBy('id', 'DESC');
    }
    ...
    {
        return $this->hasMany(\App\Models\ValidationResolutions::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Communication::class, 'parcel_id', 'id')
                ->orderBy('id', 'DESC');
    }
    ...
    {
        return $this->hasMany(\App\Models\Document::class, 'parcel_id', 'id')
                ->orderBy('id', 'DESC');
    }
    ...
    {
        return $this->hasOne(\App\Models\GuideStep::class, 'id', 'next_step');
    }
    ...
    {
        return $this->hasOne(\App\Models\ParcelsToReimbursementRequest::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasOne(\App\Models\ParcelsToPurchaseOrder::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasOne(\App\Models\ParcelsToReimbursementInvoice::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Disposition::class, 'parcel_id', 'id')
                ->orderBy('id', 'DESC');
    }
    ...
    {
        return $this->hasOne(\App\Models\PropertyStatusOption::class, 'id', 'status_id');
    }
    ...
    {
        return $this->hasOne(\App\Models\PropertyStatusOption::class, 'id', 'landbank_property_status_id');
    }
    ...
    {
        return $this->hasOne(\App\Models\PropertyStatusOption::class, 'id', 'hfa_property_status_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Retainage::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\CostItem::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\RequestItem::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\PoItems::class, 'parcel_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\InvoiceItem::class, 'parcel_id', 'id')
    ...
    {
        $import = \App\Models\ImportRow::where('row_id', $this->id)->first();
        if (!isset($import->import_id) && $this->lb_validated == 0 && isset($this->entity_id)) {
            ...
            $importRow = new \App\Models\ImportRow;
            $importRow->import_id = $import->id;
            $importRow->row_id = $this->id;
            $importRow->table_name = "parcels";
            $importRow->save();
        }
        return $this->hasOne(\App\Models\ImportRow::class, 'row_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\SiteVisits::class, 'parcel_id', 'id')
    ...
    {
        return $this->hasMany(\App\Models\VisitLists::class, 'parcel_id', 'id')
