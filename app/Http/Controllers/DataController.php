...
class DataController extends Controller
{
    ...
    public function pmRemoveSession($type, $value = null)
    {
        if (null !== $value) {
        session([$type => $value]);
        $new_filter = session($type);
    ...
    public function pmSetSessionNew(Request $request, $name=null, $value=null){
    ...
    public function pmSetSession(Request $request, $name=null, $value=null){
