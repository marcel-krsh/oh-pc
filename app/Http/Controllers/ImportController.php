                    ...
                    if ($map[$col] != '') {
                        ...
                        if (($ic[$r][$col]['db_references'] != null && $value != '' && $value != null) || ($ic[$r][$col]['db_references'] != null && (($value == '') || ($value == null)) && $ic[$r][$col]['not_null'])) {
                            ...
                            if (empty($foreign_row)) {
                                ...
                                $foreign_row = DB::table($ic[$r][$col]['db_on'])->where(Str::singular($ic[$r][$col]['db_on']).'_name', $ic[$r][$col]['excel_val'])->first();
                                if (empty($foreign_row)) {
                                    ...
                                    $o_display_col = ($ic[$r][$col]['db_on'] == 'parcels') ? 'parcel_id' : Str::singular($ic[$r][$col]['db_on']).'_name';
