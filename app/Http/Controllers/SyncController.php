...
class SyncController extends Controller
{
    ...
    public function sync() {
        ...
        if(is_null($lastModifiedDate)) {
            ...
            settype($currentModifiedDateTimeStamp1,'float');
            $currentModifiedDateTimeStamp2 = $currentModifiedDateTimeStamp1 - .001;
            $modified = date('m/d/Y g:i:s.u a',$currentModifiedDateTimeStamp2);
        }
