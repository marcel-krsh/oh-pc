...
{
    //
    public function getDocs(string $projectNumber, string $searchString = null, int $deviceId= null, string $deviceName=null){
    ...
    public function getDoc(int $documentId, int $deviceId=null , string $deviceName=null){
        $apiConnect = new DevcoService();
