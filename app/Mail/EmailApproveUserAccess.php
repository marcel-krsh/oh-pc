...
class EmailApproveUserAccess extends Mailable
{
	...
	public function build()
	{
		...
		// save in database
		if ($owner) {
			$body = \view('emails.request-request-access', compact('greeting', 'introLines', 'action_url', 'action_text', 'level', 'outroLines', 'level2'));
		...
		return $this->view('emails.request-request-access', compact('greeting', 'introLines', 'action_url', 'action_text', 'level', 'outroLines', 'level2', 'email_saved_in_db'));
	}
}
