...
class DocumentCatUpdateRecap extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $doc_cats = [
            ...
            [
             'document_category_name'=>'Advance Greening Proof of Payment', // 48
             ],
            [
             'document_category_name'=>'Recapture Invoice Signature', // 49
             ]
